...
class InputExample(object):
    ...
    def __init__(
        ...
        self.caption_unsup = tokens_unsup,
        self.labels_unsup = labels_unsup
...
class InputFeatures(object):
    ...
    def __init__(
        ...
        self.tokens_unsup = tokens_unsup
        self.labels_unsup = labels_unsup
...
class DiscourseRelationDataset(object):
    ...
    def convert_example_to_features(
        ...
        while len(tokens_unsup) < max_seq_length:
            tokens_unsup.append(0)
        ...
        features = InputFeatures(
            ...
            tokens_unsup = np.array(tokens_unsup),
            labels_unsup = labels_unsup
        )
        return features
    ...
    def __getitem__(self, index):
        ...
        caption_unsup = caption
        label_unsup =  0
        is_supervised = False
        if not is_supervised:
            caption_unsup, label_unsup = self.random_cap(caption)
            tokens_unsup = self.tokenizer.encode(caption_unsup)
        ...
        cur_example = InputExample(
            ...
            num_boxes=num_boxes,
            # overlaps=overlaps,
            tokens_unsup = tokens_unsup,
            labels_unsup = label_unsup
        )
        ...
        batch = (
            ...
            image_id.decode(),
            cur_features.tokens_unsup,
            cur_features.labels_unsup
        )
        return (
